...
<body scroll="no">
						...
						<ul class="tree treeFolder">
							<li><a href="tabsPage.html" target="navTab">主框架面板</a>
								<ul>
									...
									<li><a href="ClientList.action" target="navTab" rel="page1">ClientList</a></li>
									<li><a href="VehicleList.action" target="navTab" rel="page1">VehicleList</a></li>
	...
	<div id="footer">Copyright &copy; 2010 <a href="demo_page2.html" target="dialog">Sam Lai</a></div>
